...
public class Hotkeys {
    ...
    public static final ConfigHotkey CLEAR_EVENTS = register(new ConfigHotkey("clearEvent", "I,PERIOD", KeybindSettings.PRESS_ALLOWEXTRA).apply(HOTKEYS_CATEGORY));
    ...
    // Warning: 必须放在类的最后
    // DO NOT MOVE THIS STATIC
    // It must remain after all static ConfigHotkey fields
    public static final List<ConfigHotkey> HOTKEY_LIST = builder.build();
}
